...
import type { SkillsPageContainerProps } from '../types/skills.types';

export async function SkillsPageContainer(props: SkillsPageContainerProps): Promise<ReactElement> {
  const { locale } = props;
