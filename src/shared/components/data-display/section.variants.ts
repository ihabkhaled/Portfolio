/**
 * Section rhythm for the editorial layout. A page is a stack of sections; each
 * opens with a monospace eyebrow, a display-face title, and a hairline that
 * spans the measure. The eyebrow is metadata, so it is the only monospace text.
 */
